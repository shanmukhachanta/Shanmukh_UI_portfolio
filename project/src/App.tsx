...
import CP1 from "./assets/optimized/Concerts/credits_barrici@SA-04.webp"
import CP2 from "./assets/optimized/Concerts/AMS04090-2.webp"
import CP3 from "./assets/optimized/Concerts/Credits@baricci_SA13.webp"
import CP4 from "./assets/optimized/Concerts/Credits@baricci_MP-07367.webp"
import YYSH from "./assets/optimized/Concerts/KFxHS_B2-17.webp"
...
import IGEcho3140 from "./assets/optimized/Nightlife/yyhs-5.jpg"
...
import IGMapurohit01437 from "./assets/optimized/Nightlife/yyhs-16.webp"
...
const App = () => {
  ...
  const isFullWidthImage = (imageSrc: any) => {
    ...
    return fullWidthImages.some(
      (fullImg) =>
        imageSrc.includes(fullImg) || imageSrc.split("/").pop() === fullImg || imageSrc.split("\\").pop() === fullImg,
    )
  }
  ...
  const portfolioItems = [
    // Coldplay Images - FEATURED
    { id: 1, category: "Concerts", type: "image", src: CP1, title: "Coldplay Concert" },
    { id: 3, category: "Concerts", type: "image", src: CP2, title: "Coldplay Live Performance" },
    { id: 4, category: "Concerts", type: "image", src: CP3, title: "Coldplay Stage Show" },
    { id: 2, category: "Concerts", type: "image", src: CP4, title: "Coldplay Concert Photography" },

    // Other Concert images
    ...
    { id: 35, category: "Concerts", type: "image", src: YYSH, title: "Honey singh" },
    { id: 38, category: "Concerts", type: "image", src: ConcertVIN00330, title: "Concert Event" },
    { id: 39, category: "Concerts", type: "image", src: kailash, title: "Karan Auijla" },
    { id: 47, category: "Concerts", type: "image", src: MAP07877, title: "Club Photography" },
    { id: 49, category: "Concerts", type: "image", src: MAP09570, title: "After Hours" },
    { id: 50, category: "Concerts", type: "image", src: MAP09790, title: "Night Party" },
    { id: 55, category: "Concerts", type: "image", src: Jasleen, title: "Artist Performance" },
    ...
    // Concert Videos
    {
      ...
      category: "Concerts",
      type: "video",
      src: TimmyTrumpetVideo,
      title: "Timmy Trumpet Performance",
      format: "reel",
    },

    // Live Events (including Prateek Kuhad)
    {
      id: 25,
      category: "live-events",
      type: "video",
      src: PrateekKuhadVideo,
    ...
    { id: 16, category: "Nightlife", type: "image", src: M9A1607, title: "Night Party" },
    {
      ...
      category: "Nightlife",
      type: "video",
      src: BismilQuakeVideo,
      title: "Bismil x Quake Performance",
      format: "reel",
    },
    ...
    { id: 42, category: "Nightlife", type: "image", src: MAP00908, title: "Night Photography" },
    {
      ...
      type: "video",
      src: concertVideo1,
      title: "Anirudh Live Performance",
      format: "reel",
    },
                  ...
                  <div className="relative">
                    ...
                    <div
                      className={`absolute inset-0 transition-all duration-300 ${
                        isFeatured ? "bg-black/5 group-hover:bg-black/15" : "bg-black/0 group-hover:bg-black/20"
                      }`}
                    />
                    ...
                    <div className="absolute top-3 left-3 opacity-0 group-hover:opacity-100 transition-all duration-300">
                      ...
                      >
                        {isFeatured
                          ? "★ FEATURED"
                          : item.category === "Concerts"
                            ? "CONCERT"
                            : item.category === "Nightlife"
                              ? "Nightlife"
                              : item.category === "live-events"
                                ? "LIVE EVENT"
  ...
  const HomeSection = () => {
    ...
    return (
      <div ref={sectionRef} id="home" className="relative h-screen overflow-hidden">
        <div className="absolute inset-0 bg-cover bg-center bg-no-repeat" style={{ backgroundImage: `url(${cover})` }}>
      ...
      <div ref={sectionRef} id="work" className="py-16 bg-black">
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-gray-400">Showcasing our portfolio across all categories</p>
          </motion.div>

          {/* Auto-Sliding Category Cards */}
          <SlidingCategoryCards activeFilter={activeFilter} onFilterChange={setActiveFilter} isInView={isInView} />
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-gray-400 text-base leading-relaxed mb-6">
                We specialize in capturing the energy and emotion of live events, from Concerts to corporate gatherings.
                Using state-of-the-art equipment, we create visual stories that resonate with audiences long after the
                moment passes.
              </p>
